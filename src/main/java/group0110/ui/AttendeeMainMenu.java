...
/**
 * A main menu screen for attendee users only.
 */

public class AttendeeMainMenu extends Menu {
    ...
    public AttendeeMainMenu(User user, UserManager um, MessageManager mm, EventSystem es) {
        super(um, mm, es);
        this.user = user;
    }
